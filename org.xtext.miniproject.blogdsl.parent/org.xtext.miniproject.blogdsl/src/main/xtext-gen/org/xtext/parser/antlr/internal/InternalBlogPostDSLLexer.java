...
public class InternalBlogPostDSLLexer extends Lexer {
    ...
    public final void mRULE_ALPHANUMERIC() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlogPostDSL.g:568:19: ( ( '0' .. '9' | 'A' .. 'Z' | 'a' .. 'z' )+ '-' ( '0' .. '9' | 'A' .. 'Z' | 'a' .. 'z' )+ )
            // InternalBlogPostDSL.g:568:21: ( '0' .. '9' | 'A' .. 'Z' | 'a' .. 'z' )+ '-' ( '0' .. '9' | 'A' .. 'Z' | 'a' .. 'z' )+
            {
            // InternalBlogPostDSL.g:568:21: ( '0' .. '9' | 'A' .. 'Z' | 'a' .. 'z' )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
            ...
            match('-'); 
            // InternalBlogPostDSL.g:568:55: ( '0' .. '9' | 'A' .. 'Z' | 'a' .. 'z' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_BLOGDATE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlogPostDSL.g:570:15: ( '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' )
            // InternalBlogPostDSL.g:570:17: '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9'
            {
            matchRange('0','9'); 
            matchRange('0','9'); 
            matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlogPostDSL.g:572:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalBlogPostDSL.g:572:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalBlogPostDSL.g:572:11: ( '^' )?
            int alt3=2;
            ...
            // InternalBlogPostDSL.g:572:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlogPostDSL.g:574:10: ( ( '0' .. '9' )+ )
            // InternalBlogPostDSL.g:574:12: ( '0' .. '9' )+
            {
            // InternalBlogPostDSL.g:574:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalBlogPostDSL.g:574:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlogPostDSL.g:576:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalBlogPostDSL.g:576:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalBlogPostDSL.g:576:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalBlogPostDSL.g:576:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalBlogPostDSL.g:576:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalBlogPostDSL.g:576:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalBlogPostDSL.g:576:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlogPostDSL.g:578:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalBlogPostDSL.g:578:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalBlogPostDSL.g:578:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlogPostDSL.g:580:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalBlogPostDSL.g:580:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalBlogPostDSL.g:580:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
            ...
            // InternalBlogPostDSL.g:580:40: ( ( '\\r' )? '\\n' )?
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalBlogPostDSL.g:580:41: ( '\\r' )? '\\n'
                    {
                    // InternalBlogPostDSL.g:580:41: ( '\\r' )?
                    int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlogPostDSL.g:582:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalBlogPostDSL.g:582:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalBlogPostDSL.g:582:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBlogPostDSL.g:584:16: ( . )
            // InternalBlogPostDSL.g:584:18: .
            {
            matchAny(); 
