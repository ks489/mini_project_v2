...
import org.xtext.web.BlogPostDSLWebSetup;
...
public class BlogPostDSLServlet extends XtextServlet {
  ...
  public void init() {
    try {
        ...
        public ExecutorService get() {
          ...
          final Procedure1<ExecutorService> _function = new Procedure1<ExecutorService>() {
            ...
            public void apply(final ExecutorService it) {
              BlogPostDSLServlet.this.executorServices.add(it);
            }
          };
      ...
      BlogPostDSLWebSetup _blogPostDSLWebSetup = new BlogPostDSLWebSetup(executorServiceProvider);
      _blogPostDSLWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
